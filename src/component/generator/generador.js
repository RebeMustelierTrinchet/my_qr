...
export default function Generator() {
  ...
  qrCode.download({ name: 'qr_white', extension: 'png' });
  };
  const handleDownloadTransparent = () => {
  qrCode.update({ backgroundOptions: { color: 'transparent' } });
  qrCode.download({ name: 'qr_transparent', extension: 'png' });
  };
  ...
  useEffect(() => {
    qrCode.update({
      data: qrValue,
      dotsOptions: { type: qrShape, color: qrColor },
      backgroundOptions: { color: bgTransparent ? "rgba(0,0,0,0)" : "#ffffff" }
    });
  ...
  }, [qrValue, qrColor, qrShape, bgTransparent]);
  ...
  const downloadQR = () => {
  qrCode.download({ name: "mi_qr", extension: "png" });
  };
  ...
  return (
    <div className={styles.generator}>
      ...
      <div className={styles.leftSection}>
        ...
        {/* DOWNLOAD BUTTON */}
        {qrValue && (
        <button className={styles.generateBtn} onClick={downloadQR}>
        Download QR
        </button>
        )}
          ...
          <div className={styles.styleOptions}>
            ...
            <div className={styles.optionGroup}>
              <label>
                ...
                onChange={() => setBgTransparent(!bgTransparent)}
                />
